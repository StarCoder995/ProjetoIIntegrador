...
public class QuestaoTriangulo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.questoes_triangulo);
        ...
        questions.add(new Question("O tangram é um jogo oriental antigo, uma espécie de quebra-cabeça, constituído de sete peças. Quantos triângulos têm na imagem?", Arrays.asList("3 triângulos", "2 triângulos", "5 triângulos", "6 triângulos"), "5 triângulo"));
